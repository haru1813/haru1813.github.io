...
const post = {
  ...
  content: [
    ...
    "│  (서버)       │  접속요청  │  (클라이언트)  │",
    "├──────────────┤          ├──────────────┤",
    "│ AcceptClient │          │  Connect     │",
    "│      ↓       │          │      ↓       │",
    "│ NetworkStream│◄────────→│ NetworkStream│",
    "│  Read/Write  │  데이터   │  Read/Write  │",
    "└──────────────┘          └──────────────┘",
    "```",
    "",
    "---",
    ...
    "```",
    "┌───────────────── Message ─────────────────┐",
    "│  Header (16바이트)  │     Body (가변)      │",
    "├─────────────────────┼─────────────────────┤",
    "│ MSGID    (4바이트)  │                     │",
    "│ MSGTYPE  (4바이트)  │  BodyRequest        │",
    "│ BODYLEN  (4바이트)  │  BodyResponse       │",
    "│ FRAGMENTED (1바이트)│  BodyData           │",
    "│ LASTMSG  (1바이트)  │  BodyResult         │",
    "│ SEQ      (2바이트)  │                     │",
    "└─────────────────────┴─────────────────────┘",
    "```",
    "",
    ...
    "",
    "```",
    "클라이언트(FileSender)          서버(FileReceiver)",
    "      │                              │",
    "      │── REQ_FILE_SEND ────────────→│  파일 전송 요청",
    "      │                              │  (파일명, 크기)",
    "      │←── REP_FILE_SEND ───────────│  수락/거부 응답",
    "      │                              │",
    "      │── FILE_SEND_DATA ──────────→│",
    "      │── FILE_SEND_DATA ──────────→│  4KB 청크 단위로",
    "      │── FILE_SEND_DATA (LAST) ──→│  반복 전송",
    "      │                              │",
    "      │←── FILE_SEND_RES ──────────│  결과 (성공/실패)",
    "      │                              │",
    "```",
    "",
