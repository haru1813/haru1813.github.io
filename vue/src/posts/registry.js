...
const meta_react_styling = { id: "react-styling", title: "React 스타일링 완벽 가이드: CSS Modules, Styled Components, Tailwind, Emotion", date: "2026-03-03", summary: "React에서 사용하는 주요 스타일링 방식(인라인, CSS Modules, Styled Components, Emotion, Tailwind CSS)의 개념·문법·장단점을 비교하며 JavaScript·TypeScript 예제로 정리합니다.", category: "Technology/React", tags: ["react","css-modules","styled-components","tailwind","emotion","css-in-js","styling","typescript"], content: [] }
...
const meta_js_data_types_operators = { id: "js-data-types-operators", title: "자바스크립트 데이터 타입, 연산자, 제어문, 주요 문법", date: "2026-02-24", summary: "자바스크립트의 기본/참조 타입, 연산자, 조건문(if·switch), 반복문(for·while·forEach), 그리고 ES6+ 주요 문법(구조분해·스프레드·화살표함수·map/filter/reduce)을 예제와 함께 정리합니다.", category: "Coding/JavaScript", tags: ["javascript","data-type","object","array","operator","if","switch","for","while","forEach","es6","arrow-function","destructuring"] }
...
const meta_js_serve = { id: "js-serve", title: "serve - 정적 파일 서빙 도구", date: "2026-02-25", summary: "npm serve 패키지로 정적 파일을 로컬에서 서빙하는 방법, 옵션, SPA 지원, CORS, SSL, 프록시 설정 등을 정리합니다.", category: "Coding/JavaScript", tags: ["javascript","serve","static","npm","spa","localhost","deploy"], content: [] }
