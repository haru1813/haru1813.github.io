...
import Post_k_nearest_neighbors_algorithm from './k-nearest-neighbors-algorithm.vue'
import Post_linear_regression from './linear-regression.vue'
import Post_logistic_regression from './logistic-regression.vue'
import Post_decision_tree from './decision-tree.vue'
import Post_k_means_clustering from './k-means-clustering.vue'
import Post_artificial_neural_network from './artificial-neural-network.vue'
import Post_deep_neural_network from './deep-neural-network.vue'
import Post_neural_network_training from './neural-network-training.vue'
import Post_convolutional_neural_network from './convolutional-neural-network.vue'
import Post_recurrent_neural_network from './recurrent-neural-network.vue'
import Post_lstm_gru from './lstm-gru.vue'
...
const meta_k_nearest_neighbors_algorithm = { id: "k-nearest-neighbors-algorithm", title: "[지도학습] K-최근접 이웃 알고리즘(K-Nearest Neighbors, KNN)", date: "2026-02-16", summary: "K-최근접 이웃 알고리즘은 가장 가까운 K개의 이웃을 찾아 다수결로 분류하는 지도 학습 알고리즘입니다. 특성, 입력·타깃, 훈련, 모델, 정확도, 사이킷런 KNeighborsClassifier까지 정리합니다.", category: "Technology/AI", tags: ["ai","machine-learning","knn","scikit-learn","supervised-learning"], content: ["## K-최근접 이웃 알고리즘이란?", "가장 가까운 K개의 샘플을 찾아 다수결로 예측하는 지도 학습 알고리즘입니다."] }
const meta_linear_regression = { id: "linear-regression", title: "[지도학습] 선형 회귀(Linear Regression)", date: "2026-02-17", summary: "선형 회귀는 입력과 출력 간 선형 관계를 학습하는 지도 학습 알고리즘입니다. KNN 회귀의 한계, 직선 학습, 다항 회귀까지 정리합니다.", category: "Technology/AI", tags: ["ai","machine-learning","linear-regression","scikit-learn","supervised-learning"], content: ["선형 회귀 이론 글입니다."] }
const meta_logistic_regression = { id: "logistic-regression", title: "[지도학습] 로지스틱 회귀(Logistic Regression)", date: "2026-02-17", summary: "로지스틱 회귀는 이진 분류를 위한 지도 학습 알고리즘입니다. 시그모이드 함수, 결정 경계, 확률 출력, 사이킷런 LogisticRegression까지 정리합니다.", category: "Technology/AI", tags: ["ai","machine-learning","logistic-regression","classification","scikit-learn"], content: ["로지스틱 회귀 이론 글입니다."] }
const meta_decision_tree = { id: "decision-tree", title: "[지도학습] 결정 트리(Decision Tree)", date: "2026-02-17", summary: "결정 트리는 if-else 규칙을 트리 구조로 학습하는 지도 학습 알고리즘입니다. 분할 기준, 과적합, 가지치기, 사이킷런 DecisionTreeClassifier까지 정리합니다.", category: "Technology/AI", tags: ["ai","machine-learning","decision-tree","classification","scikit-learn"], content: ["결정 트리 이론 글입니다."] }
const meta_k_means_clustering = { id: "k-means-clustering", title: "[비지도학습] K-평균 군집화(K-Means Clustering)", date: "2026-02-17", summary: "K-평균은 정답 레이블 없이 데이터를 K개의 군집으로 나누는 비지도 학습 알고리즘입니다. 중심 갱신, inertia, 사이킷런 KMeans까지 정리합니다.", category: "Technology/AI", tags: ["ai","machine-learning","k-means","clustering","unsupervised-learning"], content: ["K-평균 군집화 이론 글입니다."] }
const meta_artificial_neural_network = { id: "artificial-neural-network", title: "[딥러닝] 인공 신경망(Artificial Neural Network, ANN)", date: "2026-02-17", summary: "인공 신경망은 뉴런을 모사한 유닛들이 연결된 구조입니다. 퍼셉트론, Dense 층, 활성화 함수, 케라스 Sequential까지 정리합니다.", category: "Technology/AI", tags: ["ai","deep-learning","neural-network","keras","tensorflow"], content: ["인공 신경망 이론 글입니다."] }
const meta_deep_neural_network = { id: "deep-neural-network", title: "[딥러닝] 심층 신경망(Deep Neural Network, DNN)", date: "2026-02-17", summary: "심층 신경망은 은닉층이 여러 개인 깊은 신경망입니다. ReLU, Flatten, 케라스 Sequential로 다층 구조를 만드는 방법을 정리합니다.", category: "Technology/AI", tags: ["ai","deep-learning","dnn","keras","relu"], content: ["심층 신경망 이론 글입니다."] }
const meta_neural_network_training = { id: "neural-network-training", title: "[딥러닝] 신경망 모델 훈련", date: "2026-02-17", summary: "신경망 훈련의 핵심: 손실 함수, 옵티마이저, 손실 곡선, Early Stopping, Dropout, 콜백을 정리합니다.", category: "Technology/AI", tags: ["ai","deep-learning","training","keras","overfitting"], content: ["신경망 훈련 이론 글입니다."] }
const meta_convolutional_neural_network = { id: "convolutional-neural-network", title: "[딥러닝] 합성곱 신경망(Convolutional Neural Network, CNN)", date: "2026-02-17", summary: "CNN은 이미지 등 격자 구조 데이터에 맞는 신경망입니다. Conv2D, MaxPooling2D, 필터, 패딩을 정리합니다.", category: "Technology/AI", tags: ["ai","deep-learning","cnn","keras","image-classification"], content: ["CNN 이론 글입니다."] }
const meta_recurrent_neural_network = { id: "recurrent-neural-network", title: "[딥러닝] 순환 신경망(Recurrent Neural Network, RNN)", date: "2026-02-17", summary: "RNN은 시퀀스·시계열 데이터를 처리하는 신경망입니다. 순환 연결, SimpleRNN, 임베딩, pad_sequences를 정리합니다.", category: "Technology/AI", tags: ["ai","deep-learning","rnn","keras","sequence"], content: ["RNN 이론 글입니다."] }
const meta_lstm_gru = { id: "lstm-gru", title: "[딥러닝] LSTM과 GRU 셀", date: "2026-02-17", summary: "LSTM과 GRU는 RNN의 장기 의존성 문제를 해결하는 셀입니다. forget gate, cell state, dropout을 정리합니다.", category: "Technology/AI", tags: ["ai","deep-learning","lstm","gru","rnn","keras"], content: ["LSTM·GRU 이론 글입니다."] }
...
export const postList = [
  ...
  { ...meta_k_nearest_neighbors_algorithm, component: Post_k_nearest_neighbors_algorithm },
  { ...meta_linear_regression, component: Post_linear_regression },
  { ...meta_logistic_regression, component: Post_logistic_regression },
  { ...meta_decision_tree, component: Post_decision_tree },
  { ...meta_k_means_clustering, component: Post_k_means_clustering },
  { ...meta_artificial_neural_network, component: Post_artificial_neural_network },
  { ...meta_deep_neural_network, component: Post_deep_neural_network },
  { ...meta_neural_network_training, component: Post_neural_network_training },
